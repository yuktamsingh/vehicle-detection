...
cap = cv2.VideoCapture('video6-1min.mp4')
input_size = 320
...
classesFile = "/home/yuktam/Desktop/vehicle detection/coco.names"
...
## Model Files
modelConfiguration = '/home/yuktam/Desktop/vehicle detection/yolov3-320.cfg'
modelWeigheights = '/home/yuktam/Desktop/vehicle detection/yolov3-320.weights'
...
def realTime():
    ...
    while True:
        ...
        cv2.putText(img, "Total Vehicles:  "+str(up_list[0]+up_list[1]+up_list[2]+up_list[3])+"     "+ str(down_list[0]+down_list[1]+down_list[2]+down_list[3]), (20, 120), cv2.FONT_HERSHEY_SIMPLEX, font_size, font_color, font_thickness)
